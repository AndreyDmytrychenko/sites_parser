...
public class HabrCarrerStrategy implements Strategy{
    ...
    public List<Vacancy> getVacancies(String searchString) {
        ...
        try {
            ...
            for (Element element : vacanciesHtmlList) {
                ...
                vacancy.setUrl("https://carrer.habr.com" + links.get(0).attr("href"));
    ...
    protected Document getDocument(String searchString, int page) throws IOException {
        return Jsoup.connect(String.format(URL_FORMAT, searchString, page))
                .userAgent("Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 OPR/81.0.4196.31")
                // .referrer("https://carrer.habr.com/")
                .get();
    }
}
